...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_ticket_dependencies_depends_on_ticket_id"),
        "ticket_dependencies",
        ["depends_on_ticket_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_ticket_dependencies_id"), "ticket_dependencies", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_ticket_dependencies_parent_ticket_id"),
        "ticket_dependencies",
        ["parent_ticket_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_ticket_artifacts_id"), "ticket_artifacts", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_ticket_artifacts_ticket_id"),
        "ticket_artifacts",
        ["ticket_id"],
        unique=False,
    )
    op.create_index(
        "ix_ticket_artifacts_type", "ticket_artifacts", ["artifact_type"], unique=False
    )
    op.create_index(
        "ix_ticket_artifacts_name", "ticket_artifacts", ["name"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_constraint(
        "uq_ticket_dependency_pair", "ticket_dependencies", type_="unique"
    )
    op.drop_index(
        op.f("ix_ticket_dependencies_parent_ticket_id"),
        table_name="ticket_dependencies",
    )
