...
from hydra.action_executor.errors import ParseError
from hydra.action_executor.parser import MultiFileParser, ResponseParser
from hydra.action_executor.types import ActionType
...
class TestResponseParser:
    ...
    def test_parse_code_blocks(self):
        ...
        assert python_actions[0].type in [
...
class TestActionTypeDetection:
    ...
    def test_command_detection(self):
        ...
        command_actions = [
            ...
            for a in actions
            if a.type
            in [ActionType.RUN_COMMAND, ActionType.INSTALL_PACKAGE, ActionType.RUN_TEST]
        ]
