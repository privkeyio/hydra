...
"""
    ...
    def test_dependency_handling(self, workspace):
        ...
        from hydra.ticket_workflow import build_dependency_graph, parse_all_tickets
...
"""
        ...
        try:
            ...
            assert (
                "DONE" in final_content
                or "COMPLETED" in final_content
                or "Complete" in final_content
            )
        except Exception:
