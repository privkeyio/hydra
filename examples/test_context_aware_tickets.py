    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        if result and Path(output_path).exists():
            ...
            features_found = {
                ...
                "Builds on references": "builds on" in content.lower()
            ...
            if all(
                [features_found["Dependencies"], features_found["Builds on references"]]
            ):
                ...
                if (
                    features_found["Required Input Files"]
                    or features_found["Context Requirements"]
                ):
