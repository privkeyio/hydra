...
class HydraConfig:
    ...
    def _load_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "agent": {"max_depth": 2, "retry_attempts": 2, "timeout": 30},
            "logging": {
                "level": "INFO",
    ...
    def _create_llm_provider(self):
        ...
        if provider_type == "venice":
            ...
            config.extra_params["claude_path"] = extra_params.get(
                "claude_path"
            ) or os.getenv("CLAUDE_CLI_PATH", "claude")
            config.extra_params["cli_flags"] = extra_params.get(
                "cli_flags"
            ) or os.getenv("CLAUDE_CLI_FLAGS", "")
            ...
            config.extra_params["preferred_backend"] = extra_params.get(
                "preferred_backend"
            ) or os.getenv(
                "SESSION_BACKEND", None
            )  # tmux, direct_process, docker
