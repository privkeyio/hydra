...
from hydra.safety.claude_file_interceptor import (
    SmartFileLockManager, FileModification, OperationType, 
...
class TestFileModification:
    ...
    def test_compatibility_checking(self):
        ...
        mod1 = FileModification("agent1", "file.py", OperationType.EDIT, "Add imports")
        mod2 = FileModification("agent2", "file.py", OperationType.EDIT, "Modify imports")
...
class TestSmartFileLockManager:
    ...
    def test_conflict_analysis(self):
        ...
        mod1 = FileModification("agent1", "test.py", OperationType.EDIT, 
                               "Add imports at top")
        mod2 = FileModification("agent2", "test.py", OperationType.EDIT,
                               "Add tests at bottom")
    ...
    def test_compatible_concurrent_access(self):
        ...
        with patch.object(self.manager.interceptor, 'acquire_file_lock', return_value=True):
    ...
    def test_configuration_strategies(self):
        ...
        self.manager.configure_resolution_strategy('incompatible', ResolutionStrategy.SKIP)
        assert self.manager.resolution_strategies['incompatible'] == ResolutionStrategy.SKIP
        
        # Test invalid strategy
        with pytest.raises(ValueError):
            self.manager.configure_resolution_strategy('invalid', ResolutionStrategy.WAIT)
    ...
    def test_lock_release_and_pending_processing(self):
        ...
        with patch.object(self.manager.interceptor.file_lock_manager, 'release_lock'):
            with patch.object(self.manager, '_acquire_lock', return_value=True) as mock_acquire:
                # Release lock
